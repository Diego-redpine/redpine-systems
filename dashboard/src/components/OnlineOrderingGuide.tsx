    ...
    <div className="p-6 shadow-sm" style={{ backgroundColor: cardBg }}>
      <div className="flex items-center justify-between mb-4">
        ...
        <button
          ...
          className="px-3 py-1.5 text-xs font-medium border transition-colors hover:bg-gray-50"
      ...
      <div className="p-4 border" style={{ borderColor, backgroundColor: '#F9FAFB' }}>
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          <div>
            ...
            <input
              ...
              min={1}
              className="w-full px-3 py-2 text-sm border focus:outline-none focus:ring-2 focus:ring-blue-300"
              style={{ borderColor, color: textMain }}
            />
          </div>
          <div>
        ...
        <div className="mt-3 text-center p-2 bg-emerald-100">
      ...
      {expanded && (
        <div className="mt-4 space-y-4">
          ...
          {/* Get Started */}
          <div className="p-4 border-2" style={{ borderColor: buttonBg }}>
