      ...
      {gigs.length === 0 ? (
        ...
        <div className="space-y-3">
          {gigs.map(gig => {
            ...
            return (
              <div key={gig.id} className="rounded-2xl p-5 shadow-sm" style={{ backgroundColor: cardBg }}>
                <div className="flex items-start justify-between mb-3">
                  ...
                  <span className={`px-2.5 py-0.5 text-xs font-medium rounded-full capitalize ${style.bg} ${style.text}`}>
                    {gig.status}
                  </span>
                </div>
                ...
                <div className="flex items-center gap-2 pt-3 border-t" style={{ borderColor }}>
                  <button
                    ...
                    className="px-3 py-1.5 text-xs font-medium rounded-lg transition-colors hover:bg-gray-100"
                  ...
                  <button
                    ...
                    className="px-3 py-1.5 text-xs font-medium rounded-lg text-red-500 transition-colors hover:bg-red-50 ml-auto"
                  >
                    Delete
                  </button>
                </div>
